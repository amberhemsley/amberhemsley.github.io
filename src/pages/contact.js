        ...
        <div className="contact-page">
            ...
            <body>
                <div style={{display:"flex",justifyContent: "center", padding:`20px`}}>
                    <Card sx={{ width: '50vw',maxWidth:'400px', backgroundColor:'rgba(0, 0, 0, 0.05)'}}>
                        <CardContent>
                            <Grid container spacing={0}>
                                <Grid item xs={4}>
                                    <Chip label="Email:" icon={<AlternateEmailIcon  sx={{color:'#0077b5'}}/>} sx={{backgroundColor:'rgba(0, 0, 0, 0)', fontSize:'medium'}}/>
                                </Grid>
                                <Grid item xs={8}>
                                    <Chip label={<a href="mailto:amberhemsley02@gmail.com" style={{color:'#DA8FB1'}}> amberhemsley02@gmail.com</a>}
                                          sx={{backgroundColor:'rgba(0, 0, 0, 0)', fontSize:'medium'}}/>
                                </Grid>
                                <Grid item xs={4}>
                                    <Chip label="LinkedIn:" icon={<LinkedInIcon  sx={{color:'#0077b5'}}/>} sx={{backgroundColor:'rgba(0, 0, 0, 0)', fontSize:'medium'}}/>
                                </Grid>
                                <Grid item xs={8}>
