   ...
   return (
        <Box sx={{width:'80vw'}}>
            ...
            <Typography variant="body1">
                <List sx={{p:'2px', paddingRight:'60px'}}>
                    <ListItem sx={{paddingY:'2px', overflow:'wrap', maxWidth:'80wh'}}>- Contributed to the maintenance and creation of Dojo’s public APIs in Golang connecting terminals to points of sale through both websockets and REST</ListItem>
